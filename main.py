...
# Configurazione del bot con gli intenti necessari
...
async def clona_emoji(interaction: discord.Interaction, source_guild_id: str):
    ...
    if not source_guild:
        await interaction.followup.send("❌ Non sono riuscito a trovare il server sorgente. Il bot è presente anche lì?", ephemeral=True)
        return
